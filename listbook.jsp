...
try {
	...
	while (rst.next()) {
		...
		out.println("<tr><td><center>"+rst.getString("book_id")+"</td><td>"+rst.getString("title")+"</td>");
		
		out.println("<td>"+rst.getString("author")+"</td><td>"+rst.getString("Publication")+"</td>");
		
		out.println("<td>"+rst.getString("Price")+"</td><td>"+rst.getString("Edition")+"</center></td></tr>");
